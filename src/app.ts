...
alert("Vladik dikiy huesos")


//     let i = 1
//     let road = '<div class="blockCar"><div class="settInfo"><button class="select">Select</button><button class="remove">Remove</button><div class="namCar">Name</div></div><div class="road"><div class="startStop"><button class="start">A</button><button class="stop" disabled/>B</button></div><div class="way"> <img class="carImg" src="../async-race-api/src/assets/clipart2163587.png" alt="car"><img class="flag" src="../async-race-api/src/assets/pngwing.com.png" alt="flag"></div></div></div>'
